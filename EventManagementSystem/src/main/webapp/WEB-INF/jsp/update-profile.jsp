            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card mt-5">
                        ...
                        <div class="card-body">
                            <form:form method="POST" action="update-profile.htm" modelAttribute="user">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <%-- <input type="number" class="form-control" id="streetNum" name="streetNum" value="${address.streetNum}" /> --%>
                                </div>
                                <div class="form-group mt-3">
                                    ...
                                    <%-- <input type="text" class="form-control" id="streetName" name="streetName" value="${address.streetName}" /> --%>
                                </div>
                                <div class="form-group mt-3">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <%-- <input type="number" class="form-control" id="zip" name="zip" value="${address.zip}" /> --%>
                                </div>
                                <div class="form-group mt-3">
