            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card mt-5">
                        ...
                        <div class="card-body">
                            <form:form method="POST" action="create-event.htm" enctype="multipart/form-data" modelAttribute="event">
							  ...
							  <div class="form-group mt-3">
							    ...
							    <form:input path="startDateTime" class="form-control" id="startDateTime" type="datetime-local" required="true"/>
							    <form:errors path="startDateTime" class="text-danger"/>
							  </div>
							
							  <div class="form-group mt-3">
							    <label for="endDateTime">End Date and Time</label>
							    <form:input path="endDateTime" class="form-control" id="endDateTime" type="datetime-local" required="true"/>
							    <form:errors path="endDateTime" class="text-danger"/>
							  </div>
							
							  <div class="form-group mt-3">
							    <label for="numberOfTickets">Number of Tickets</label>
							    <form:input path="numberOfTickets" class="form-control" id="numberOfTickets" type="number" required="true"/>
							  ...
							  <div class="form-group mt-3">
							    ...
							    <div class="input-group">
							      ...
							      <form:input path="cost" class="form-control" id="cost" type="number" step="0.01" min="0" required="true"/>
